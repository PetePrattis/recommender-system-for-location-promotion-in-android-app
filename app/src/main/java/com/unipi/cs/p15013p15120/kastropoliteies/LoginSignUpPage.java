...
/*
User can create an account for Kastropoliteies app using gmail or email + password
or user can log in to a pre-existing account using gmail or email + password
